...
if __name__ == '__main__':
    predictor_1 = NNUnetCTPredictor(
        ...
        plan_file=f'{path.path_root}/nnUnet/Models/nnUNet/3d_fullres/Task_101_VertebralLocation_GeneratePseudoLabel/nnUNetTrainerV2__nnUNetPlansv2.1/plans.pkl',
        plan_stage=-1,
    ...
    predictor_2 = PredictorStage2(
        list_model_pth=[
            f'{path.path_root}/nnUnet/Models/nnUNet/3d_fullres/Task_202_FractureDetection/nnUNetTrainerV2__nnUNetPlansv2.1/all/model_final_checkpoint.model'
        ],
        plan_file=f'{path.path_root}/nnUnet/Models/nnUNet/3d_fullres/Task_202_FractureDetection/nnUNetTrainerV2__nnUNetPlansv2.1/plans.pkl',
        plan_stage=-1,
        device=torch.device('cuda:0'),
        use_gaussian_for_sliding_window=True,
    ...
    c2f_predictor.predict_from_nii_dir(
        ...
        output_dir=f"{path.path_root}/CompetitionData/PredictedFractureV2",
