...
cfg.train_df = f'{cfg.data_dir}/train_image_pseu_v06_crop.csv.gz'
cfg.bbox_df = f'{cfg.data_dir}/train_bbox_pred_v02.csv.gz'
cfg.bboxall_df = f'{cfg.data_dir}/train_bbox_all_pred_v02.csv.gz'
...
#model
cfg.model = "mdl_dh_seg_3G_gx1_cam" # "mdl_dh_seg_3G_gx1"
...
# DATASET
cfg.dataset = "ds_dh_fracseg_3Q_crop"
if platform.system() == 'Darwin':
